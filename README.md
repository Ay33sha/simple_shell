...
* Aisha Nasir <[Ay33sha](https://github.com/Ay33sha)>

* Udeani Henry <[udeani](https://github.com/udeani)>
...
This project was written as part of the curriculum for ALX. ALX is a campus-based full-stack software engineering program that prepares students for careers in the tech industry using project-based peer learning.
